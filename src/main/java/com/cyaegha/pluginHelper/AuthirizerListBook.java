...
import com.cyaegha.pluginHelper.annotations.AuthirizerListNeed;
import com.cyaegha.pluginHelper.annotations.MinimumAuthority;
import com.cyaegha.surveillance.Log;

public class AuthirizerListBook implements Permission
{
	...
	{
		File pfile=new File(authirizerPath);
	...
	protected void connectClassWithAuthirizerList(String className,String authirizerListName)
	{
		...
		if(map.containsKey(authirizerListName))
			...
			map.put(authirizerListName,new AuthirizerList(authirizerPath
	...
	protected boolean createNewAuthirizerList(String name)
	{
		...
		{
			String file=authirizerPath+name+".xml";
